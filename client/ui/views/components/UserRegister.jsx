          ...
          <Col md={8}>
            <Card className='h-100' body>
              ...
              <Form className='mt-4' onSubmit={onSubmit}>
                ...
                <InputWithErrors label='Mot de passe' value={password} onChange={setPassword} error={errorPassword}
                                 placeholder='password' type='password'/>
    
                <InputWithErrors label='Confirmation de mot de passe' value={passwordConfirmation}
                                 onChange={setPasswordConfirmation}
                                 error={errorPasswordConfirmation} placeholder='password' type='password'/>
