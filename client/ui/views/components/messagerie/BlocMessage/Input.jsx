...
useEffect(() => {
    ...
    socketRef.current.on("update_message", ({conversations, newConversation, conversationAMAJ, author }) => {
    ...
    socketRef.current.on("delete_message", ({conversationAMAJ, author, newConversation, conversations }) => {
        // Ici on cherche la conversation qu'on a mis a jour et on la met a jour
        conversations[conversationAMAJ] = newConversation;
